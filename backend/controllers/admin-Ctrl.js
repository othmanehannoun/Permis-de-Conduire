...
const adminCtrl = {
    ...
    Login : async (req, res, next) =>{
        ...
        try {
        const admin = await Conducteur.findOne({ email });
        if (admin) {
    ...
    //---------------updating Conducteur-------------------//
    updateConducteur : async(req, res) => {

      Conducteur.updateOne({_id: req.params.id}, {numPoint: req.body.numPoint})
      
   
      .then(() => res.send("Conducteur Confirmed successfully"))
